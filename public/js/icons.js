// Lucide-style SVG icon library (24x24, currentColor)
// All icons use stroke instead of fill for a modern, crisp look
(function() {
  'use strict';
  ...
  const I = (path, opts = {}) => {
    ...
    return `<svg viewBox="0 0 24 24" width="${sz}" height="${sz}" fill="none" stroke="currentColor" stroke-width="${stroke}" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
  };
  ...
  const icons = {
    ...
    videoOff: '<path d="M10.66 5H14a2 2 0 0 1 2 2v3.34l1 1L22 7v10"/><path d="M16 16a1 1 0 0 1-1 1"/><path d="m2 2 20 20"/><path d="M2 7v10a2 2 0 0 0 2 2h9"/>',
    ...
    trash: '<path d="M3 6h18"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/>',
    ...
    trash2: '<polyline points="3 6 5 6 21 6"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="m9 6 1-4h4l1 4"/>',
    ...
    archive: '<polyline points="21 8 21 21 3 21 3 8"/><rect width="22" height="5" x="1" y="3"/><line x1="10" y1="12" x2="14" y2="12"/>',
    ...
    smile2: '<circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/>',
    clock: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
    camera: '<path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/>',
    cameraOff: '<line x1="2" y1="2" x2="22" y2="22"/><path d="M7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16"/><path d="M9.5 4h5L17 7h3a2 2 0 0 1 2 2v3.5"/>',
    ...
    mic2: '<path d="m12 1 2 4-2 2-2-2Z"/><path d="m12 15 2 4-2 2-2-2Z"/><path d="M5 9l4 2-1 3-3-1Z"/><path d="m19 9-4 2 1 3 3-1Z"/><path d="M2 12h6"/><path d="M16 12h6"/>'
  };
  ...
  const Icons = {
    ...
    raw(name) { return icons[name] || ''; }
  };

  window.QWAS.Icons = Icons;
})();
